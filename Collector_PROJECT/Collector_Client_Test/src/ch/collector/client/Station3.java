...
public class Station3 {
	...
	public static void login() throws IOException {
		...
		out.writeUTF("test_login LOGIN Station3 1234 ");
		out.flush();
	...
	public static void sendData() throws IOException, InterruptedException {
		...
		while (true) {
			...
			if (s1.equals("DATAQUERY")) {
				...
				out.writeUTF(" DATA "+(System.currentTimeMillis()) +" 903 PR 3 "+(new Random().nextInt(20)) +" 0 20.2 TE 7 "+(new Random().nextInt(30))+" 0 30.2 ");
				out.flush();
                break;
			}
			System.out.println("...");
